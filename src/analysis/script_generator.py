...
1. 【opening】: 
    ...
    - 【重要：on_screen_textの指示】: 以下を1行ずつ箇条書きで表示してください。
        "・米国市場の動向"
        "・米国注目ニュース：{analysis_data.get('selected_thumbnail_title', '本日のトピック')[:15]}..."
        "・米国セクター分析"
        "・日本市場への影響予測"
        "・まとめ"
...
3. 【誠実なぼかし】：明確な理由がない場合は「謎」とせず、「今は材料待ちで市場が様子見をしているようです」や「過熱感から利益確定の売りが出た可能性があります」など、市場心理を推測して伝えてください。
4. 【具体性】：ニュースは「ある企業が〜」ではなく「NVIDIAが〜」と実名を出してください。
5. 【数値】：株価や騰落率などの数値は「大きく動いた」ではなく「300円安の〇〇円」などと具体的に述べてください。また、数値は「38,567.23円」だったら、「3万8500円付近」や「3万8560円」など、耳で聞いてわかりやすい表現に丸めてください。
6. 【感情の同期】：市場が好調なら「happy/excited」、大幅下落なら「sad/disappointed」など、ニュースの内容に合わせた感情を選択してください。
7. 【行動指針の提示】：最後に「今日はまず〇〇をチェックしましょう」など、視聴者が次に取るべきアクションを具体的に指示してください。
8. 【データ不足時の対応】：対応するデータがない場合、データがない旨を伝える。
...
1. 【opening】: 
    ...
    - 【重要：on_screen_textの指示】: 以下を1行ずつ箇条書きで表示してください。
        "・市場の動向"
        "・注目ニュース：{analysis_data.get('selected_thumbnail_title', '本日のトピック')[:15]}..."
        "・決算・株主総会スケジュール"
        "・セクター分析"
        "・注目銘柄のIR"
        "・前回紹介銘柄の動向"
...
3. 【誠実なぼかし】：明確な理由がない場合は「謎」とせず、「今は材料待ちで市場が様子見をしているようです」や「過熱感から利益確定の売りが出た可能性があります」など、市場心理を推測して伝えてください。
4. 【具体性】：ニュースは「ある企業が〜」ではなく「トヨタ自動車が〜」と実名を出してください。
5. 【数値】：株価や騰落率などの数値は「大きく動いた」ではなく「300円安の〇〇円」と具体的に述べてください。また、数値は「38,567.23円」だったら、「3万8500円付近」や「3万8560円」など、耳で聞いてわかりやすい表現に丸めてください。
6. 【感情の同期】：市場が好調なら「happy/excited」、大幅下落なら「sad/disappointed」など、ニュースの内容に合わせた感情を選択してください。
7. 【行動指針の提示】：最後に「明日の朝はまず〇〇をチェックしましょう」など、視聴者が次に取るべきアクションを具体的に指示してください。
8. 【データ不足時の対応】：決算/総会データがない場合、「本日の予定はありません」と事実を伝える。前回紹介銘柄データがない場合、このセクション自体をスキップするか、手短に次へ進む。
